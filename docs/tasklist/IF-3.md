...
- [ ] **Task 1: Add required imports to main.rs**
...
- [ ] **Task 2: Initialize logging with env_logger**
...
- [ ] **Task 3: Load PNG image and convert to RGBA8**
...
- [ ] **Task 4: Extract dimensions and get raw bytes**
...
- [ ] **Task 5: Reconstruct image and save to output path**
...
- [ ] **Task 6: Remove old debug println! statements**
...
- [ ] **Task 7: Create test_images directory and sample.png**
...
- [ ] **Task 8: Create placeholder params file**
